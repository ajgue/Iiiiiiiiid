...
for i = 1, 30 do
    ...
    dot.Parent = particlesFrame

    task.spawn(function()
        while dot and dot.Parent do
            local newX = math.random()
            local newY = math.random()
            local tweenInfo = TweenInfo.new(math.random(2, 5), Enum.EasingStyle.Linear)
...
-- إعدادات ألوان GUI
local presetColors = {
    ["أبيض"] = Color3.fromRGB(255, 255, 255),
    ["أسود"] = Color3.fromRGB(0, 0, 0),
    ["أحمر"] = Color3.fromRGB(255, 0, 0),
    ["أخضر"] = Color3.fromRGB(0, 255, 0),
    ["أزرق"] = Color3.fromRGB(0, 0, 255),
    ["أصفر"] = Color3.fromRGB(255, 255, 0),
    ["برتقالي"] = Color3.fromRGB(255, 165, 0),
    ["وردي"] = Color3.fromRGB(255, 192, 203),
    ["بنفسجي"] = Color3.fromRGB(128, 0, 128),
    ["سماوي"] = Color3.fromRGB(0, 255, 255),
    ["رمادي فاتح"] = Color3.fromRGB(211, 211, 211),
    ["رمادي غامق"] = Color3.fromRGB(105, 105, 105),
    ["بني"] = Color3.fromRGB(139, 69, 19),
    ["ذهبي"] = Color3.fromRGB(255, 215, 0),
    ["فضي"] = Color3.fromRGB(192, 192, 192),
    ["بنفسجي فاتح"] = Color3.fromRGB(216, 191, 216),
    ["أزرق غامق"] = Color3.fromRGB(0, 0, 139),
    ["أخضر غامق"] = Color3.fromRGB(0, 100, 0)
}
...
AddDropdown(SettingsTab, {
    Name = "لون الخلفية",
    Options = table.keys(presetColors),
    Default = "أسود",
    Callback = function(selected)
        Configs_HUB.Cor_Hub = presetColors[selected]
    end
})
...
AddDropdown(SettingsTab, {
    ...
    Default = "رمادي فاتح",
    Callback = function(selected)
        Configs_HUB.Cor_Options = presetColors[selected]
    end
})
...
AddDropdown(SettingsTab, {
    ...
    Default = "أبيض",
    Callback = function(selected)
        Configs_HUB.Cor_Text = presetColors[selected]
        Configs_HUB.Cor_DarkText = presetColors[selected]
    end
})
...
AddDropdown(SettingsTab, {
    ...
    Default = "أخضر",
    Callback = function(selected)
        Configs_HUB.Cor_Stroke = presetColors[selected]
    end
})
